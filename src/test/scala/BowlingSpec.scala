...
class ScorecardSpec   extends FlatSpec with Matchers {
  ...
  "The scorecard generated by 9 rolls of 10 " should "Report the next roll as 'Frame 10: Roll 1'" in {
    val afterF9R1 = rollNineStrikes
    afterF9R1.nextRoll shouldBe "Frame 10: Roll 1"
  }

  "The scorecard generated by 9 rolls of 10 and 2 rolls of 0 " should "Reject a new roll as 'Game Over'" in {
    val afterF10R1 = rollNineStrikes.roll(0)
    val afterF10R2 = afterF10R1.right.get.roll(0)
    afterF10R2.right.get.frames.length shouldBe 10
  ...
  "The scorecard generated by a roll of 1, a roll of 2 and a roll of 3" should "Show a second frame with a score of 3" in {
    val afterF1R1 = new Scorecard().roll(1)
    val afterF1R2 = afterF1R1.right.get.roll(2)
    val afterF2R1 = afterF1R2.right.get.roll(3)
    afterF2R1.isRight shouldBe true
  ...
  "The scorecard generated by a strike and a roll of 3" should "Show a second frame with a first roll of 3" in {
    val afterF1R1 = new Scorecard().roll(10)
    val afterF2R1 = afterF1R1.right.get.roll(3)
    afterF2R1.isRight shouldBe true
    afterF2R1.right.get.getFrame(1).get.getRoll(0) shouldBe Some(3)
  }

  "The scorecard generated by a strike and a roll of 3" should "Show a first frame with a first roll of 10" in {
    val afterF1R1 = new Scorecard().roll(10)
    val afterF2R1 = afterF1R1.right.get.roll(3)
    afterF1R1.right.get.getFrame(0).get.getRoll(0) shouldBe Some(10)
  }

  "The scorecard generated by nine strikes" should "have nine frames" in {
    val nineStrikes = rollNineStrikes
    nineStrikes.frames.length shouldBe 9
  }

  "The scorecard generated by nine strikes" should "show a ninth frame with a first roll of 10" in {
    val nineStrikes = rollNineStrikes
    nineStrikes.getFrame(8).get.rolls.length shouldBe 1
    nineStrikes.getFrame(8).get.getRoll(0) shouldBe Some(10)
  }

  "The scorecard generated by a strike in the tenth frame, then a bonus roll of 10" should "Allow a further roll, with pins reset'" in {
    val afterF10R1 = rollNineStrikes.roll(10)
    val afterBonus1 = afterF10R1.right.get.roll(10)
    val afterBonus2 = afterBonus1.right.get.roll(10)
    afterBonus2.isRight shouldBe true
  ...
  "The scorecard generated by a strike in the tenth frame, then a bonus roll of 4" should "have 6 pins left, allowing a roll of 6'" in {
    val afterF10R1 = rollNineStrikes.roll(10)
    val afterBonus1 = afterF10R1.right.get.roll(4)
    val afterBonus2 = afterBonus1.right.get.roll(6)
    afterBonus2.isRight shouldBe true
  }

  "The scorecard generated by a strike in the tenth frame, then a bonus roll of 4" should "have 6 pins left, disallowing a roll of 7" in {
    val afterF10R1 = rollNineStrikes.roll(10)
    val afterBonus1 = afterF10R1.right.get.roll(4)
    val afterBonus2 = afterBonus1.right.get.roll(7)
    afterBonus2.isLeft shouldBe true
  }

  "The scorecard generated by a spare in the tenth frame, then a bonus roll of 10"  should "Show a tenth frame with 3 rolls" in {
    val afterF10R1 = rollNineStrikes.roll(5)
    val afterF10R2 = afterF10R1.right.get.roll(5)
    val afterBonus1 = afterF10R2.right.get.roll(10)
    afterBonus1.isRight shouldBe true
    afterBonus1.right.get.getFrame(9).get.rolls.length shouldBe 2
    afterBonus1.right.get.getFrame(9).get.bonuses.length shouldBe 1
  }

  "The scorecard generated by a perfect game"  should "Show a tenth frame with 1 roll and 2 bonuses" in {
    val afterF10R1 = rollNineStrikes.roll(10)
    val afterBonus1 = afterF10R1.right.get.roll(10)
    val afterBonus2 = afterBonus1.right.get.roll(10)
    afterBonus2.isRight shouldBe true
    afterBonus2.right.get.getFrame(9).get.rolls.length shouldBe 1
    afterBonus2.right.get.getFrame(9).get.bonuses.length shouldBe 2
  }

  "The scorecard generated by a spare in the first frame followed by a roll of 1" should "Report that the first frame is a spare" in {
    val afterF1R1 = new Scorecard().roll(3)
    val afterF1R2 = afterF1R1.right.get.roll(7)
    val afterF2R1 = afterF1R2.right.get.roll(1)
    afterF2R1.isRight shouldBe true
    afterF2R1.right.get.getFrame(0).get.isSpare shouldBe true
  }

  "The scorecard generated by a spare in the first frame followed by a roll of 1" should "Show a first frame with a score of 11" in {
    val afterF1R1 = new Scorecard().roll(3)
    val afterF1R2 = afterF1R1.right.get.roll(7)
    val afterF2R1 = afterF1R2.right.get.roll(1)
    afterF2R1.isRight shouldBe true
    afterF2R1.right.get.getFrame(0).get.score shouldBe 11
  }

  "The scorecard generated by a strike in the first frame followed by a roll of 1 and a roll of 2" should "Show a first frame with a score of 13" in {
    val afterF1R1 = new Scorecard().roll(10)
    val afterF2R1 = afterF1R1.right.get.roll(1)
    val afterF2R2 = afterF2R1.right.get.roll(2)
    afterF2R2.isRight shouldBe true
    afterF2R2.right.get.getFrame(0).get.score shouldBe 13
  }
